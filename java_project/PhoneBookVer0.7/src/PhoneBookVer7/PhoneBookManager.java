	...
	public void deptEdit() {
		...
		//	sc.nextLine();
			...
			if (rowCnt > 0) {
				...
				int resultCnt = dao.deptEdit(newPb, conn);
	...
	public void pbList() {
		...
		if (pbList != null && !pbList.isEmpty()) {
			...
			for (int i = 0; i < pbList.size(); i++) {
				System.out.printf("%5s", pbList.get(i).getDeptno() + "\t");
				System.out.printf("%12s", pbList.get(i).getDname() + "\t");
				System.out.printf("%12s", pbList.get(i).getLoc() + "\n");
			}
		} else {
