...
public class DBCPInit extends HttpServlet {
	...
	private void initConnectionPool() {
		...
		try {
			//jdbc:mysql://aia.cek50lbziasl.ap-northeast-2.rds.amazonaws.com
			...
			String jdbcDriver = "jdbc:mysql://localhost:3306/finalproject?autoReconnect=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=UTC";
			String username = "aia";
			String pw = "aia";
